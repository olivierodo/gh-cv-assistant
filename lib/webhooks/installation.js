module.exports = function (robot) {
  ...
  return async context => {
    ...
    if (payload.repositories && 0 === payload.repositories.length) {
    ...
    if (1 !== payload.repositories.length) {
    ...
    const empty = 0 === gitTree.tree.filter( _=> _.path.match(REGEXP_RESUME_FILE)).length;
